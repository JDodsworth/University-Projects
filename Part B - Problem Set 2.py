...
def vasicek_sim(initial, final_time, sim_path_len, num_paths = None,*, a, b, 
    ...
    """Returns a given number of paths that represent interest rates 
    over a period of time using the Vasicek interest model and 
    ...
    *allow_neg : bool, optional
    ...
    Returns
    -------
    list of floats or list of list of floats
    ...
    # interest rates. 
    return paths if num_paths > 1 else paths[0] 
